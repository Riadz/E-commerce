	...
	<div id="main-container">
		...
		<section>
			<div class="edit-form form-container">
				<!-- info -->
				<form method="POST" enctype="multipart/form-data" action="php/actions/add_article.php">
					...
					<div id="sections-container">
						<div class="section">
							...
							<input name="article_name" minlength="4" required>
							<span>Article brand</span>
							<input name="brand" minlength="4" required>
							<span>Category</span>
						...
						<div class="section">
							<span>Stock</span>
							<input name="stock" type="number" min="0" max="10000">
							<span>Price (DA)</span>
							<input name="price" type="number" min="1" max="10000000">
							<span>Discount (%)</span>
					...
					<div class="section" style="width: 85%;">
						...
						<input name="thumbnail" type="file" accept="image/x-png,image/gif,image/jpeg" required />
					...
					<textarea class="mce-textarea" name="description"></textarea>
					<div class="form-header" style="margin-top: 2rem">
						<h2>Characteristics</h2>
					</div>
					<textarea class="mce-textarea" name="characteristics"></textarea>
